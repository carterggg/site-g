...
<!-- END OF MOBILE NAV -->			
	...
	<div class="row">
		<div class="col-xs-12">
			<a href="index.html" title="Graphic Design: Carter Guthrie"><img src="images/layout/titleheader.png" onmouseover="this.src='images/layout/titleheader2.png'" onmouseout="this.src='images/layout/titleheader.png'"  alt="Graphic Design: Carter Guthrie" class="img-responsive hidden-xs"></a>
...
<!-- DESKTOP NAV -->
		...
		<div class="nav-desktop-position">
			<a href="index.html"><img src="images/layout/home.png" onmouseover="this.src='images/layout/home2.png'" onmouseout="this.src='images/layout/home.png'"   alt="Graphic Design: Carter Guthrie. Home Page" class="img-responsive" width="190px"></a>
			<a href="services.html"><img src="images/layout/services.png" onmouseover="this.src='images/layout/services2.png'" onmouseout="this.src='images/layout/services.png'"  alt="Graphic Design: Carter Guthrie. Services Page" class="img-responsive" width="190px"></a>
			<a href="designs.html"><img src="images/layout/designs.png" onmouseover="this.src='images/layout/designs2.png'" onmouseout="this.src='images/layout/designs.png'"  alt="Graphic Design: Carter Guthrie. Designs Page" class="img-responsive" width="190px"></a>
			<a href="contact.php"><img src="images/layout/contact.png" onmouseover="this.src='images/layout/contact2.png'" onmouseout="this.src='images/layout/contact.png'"  alt="Graphic Design: Carter Guthrie. Contact Page" class="img-responsive" width="190px"></a>
			<a href="pay.html"><img src="images/layout/pay.png" onmouseover="this.src='images/layout/pay2.png'" onmouseout="this.src='images/layout/pay.png'"  alt="Graphic Design: Carter Guthrie. Pay Page" class="img-responsive" width="190px"></a>
		</div>
		</div>
<!-- END OF DESKTOP NAV -->
		<div class="hidden-xs col-sm-1"></div>
		...
		<div class="hidden-xs col-sm-10 footer-background-content">
			<nav>
				<ul>
					...
					<li class="footer-nav-style"><a href="contact.php" title="Graphic Design with Carter Guthrie">CONTACT</a></li>
					<li class="footer-nav-style"><a href="pay.html" title="Graphic Design with Carter Guthrie">PAY</a></li>
					<li class="footer-nav-style"><a href="http://carterguthrie.com/web/index.html" title="Web Design with Carter Guthrie">WEB DESIGN</a></li>
				</ul>
			</nav>
